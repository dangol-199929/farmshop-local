          ...
          <div className="md:col-span-2">
            <Card>
              <CardContent className="space-y-4 p-4">
                <div className="text-2xl font-semibold bg-primary text-white p-4 rounded-md">
                ...
                <Card>
                  <CardContent className="p-4">
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        <strong>Position Type:</strong> {jobData?.position_type}
                      </div>
                      <div>
                        <strong>Posted Date:</strong> {jobData?.posted_date}
                      </div>
                      <div>
                        <strong>Deadline Date:</strong> {jobData?.deadline_date}
                      </div>
                      <div>
                        <strong>Number of Openings:</strong> {jobData?.openings}
                      </div>
                      <div>
            ...
            <Card>
              <CardContent className="space-y-4 p-4">
                <Button
                  ...
                  className="w-full"
                  onClick={() => {
                    router.push(`/job-vacancy/${slug}/apply`);
                  }}
                >
                  Apply for This Job
                </Button>
