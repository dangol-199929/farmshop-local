...
const CareerPage: NextPageWithLayout = () => {
  ...
  const handleViewDetails = (slug: string) => {
    router.push(`/page/job-vacancy/${slug}`);
  };
  ...
  const getRemainingDaysMessage = (deadlineDate: string) => {
            ...
            <div>
              ...
              <CardContent className="space-y-4 px-0 mt-10 ">
                {paginatedData?.map((job, index) => (
                  ...
                  >
                    <CardContent className="grid grid-cols-12 justify-between items-center gap-3 p-4">
                      <div className="space-y-2 col-span-12 md:col-span-10">
                        ...
                        <div className="flex flex-col md:flex-row item-start md:items-center gap-2 text-sm text-muted-foreground">
                          ...
                          <span className="flex items-center font-normal">
                            ...
                            {getRemainingDaysMessage(job.deadline_date)})
                          </span>
                        </div>
                        <div className="col-span-8 overflow-hidden line-clamp-2 w-full h-[44px]">
                          <p
                      ...
                      <Button
                        variant="primary"
                        className="shrink-0 col-span-12 md:col-span-2"
                ...
                <div className="flex justify-end items-center mt-4 gap-4">
                  ...
                  <Button
                    ...
                    size="icon"
                    className={`${
                      (paginatedData?.length ?? 0) < itemsPerPage
                        ? "hidden"
                        : ""
                    }`}
                  >
